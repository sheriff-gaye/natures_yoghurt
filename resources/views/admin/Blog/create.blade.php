                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="blog_status" id="blog_status" class="form-control">
                                    ...
                                    <option value="1" {{ old('blog_status') == '1' ? 'selected' : null }}>Active
                                    </option>
                                    <option value="0" {{ old('blog_status') == '0' ? 'selected' : null }}>Inactive
                                    </option>
                                </select>
                                @error('blog_status')
                                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="blog_description" rows="3" class="form-control">{!! old('blog_description') !!}</textarea>
